...
public class VtnLogin extends javax.swing.JFrame {
    ...
    public VtnLogin() {
        ...
        pwdContra.setText("Admin");
        
    }
    
    
    public VtnLogin(Empresa miEmpresa) {
        initComponents();
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(pwdContra, javax.swing.GroupLayout.DEFAULT_SIZE, 120, Short.MAX_VALUE))))
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        int resultado = miEmpresa.buscar(login,passwordEncriptada);
        ...
        if (resultado != -1) {
            ...
            new VtnMenu(miEmpresa, resultado).setVisible(true);
